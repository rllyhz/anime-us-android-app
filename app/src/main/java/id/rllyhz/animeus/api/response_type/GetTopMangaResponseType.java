...
public class GetTopMangaResponseType {
    ...
    public GetTopMangaResponseType(String requestHash, boolean requestCached, int requestCacheExpiry, List<Manga> mangaList) {
