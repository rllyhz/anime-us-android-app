...
public class RecycleviewItemAnimator {
    /* animation duration */
    ...
    public static void animateBottomUp(View view, int position) {
        ...
        animatorTranslateY.setStartDelay(not_first_item ? 0 : (position * DURATION_IN_BOTTOM_UP / 20));
...
//        animatorAlpha.setStartDelay(not_first_item ? DURATION_IN_FADE_ID / 2 : (position * DURATION_IN_FADE_ID / 3));
        animatorAlpha.setStartDelay(not_first_item ? DURATION_IN_FADE_ID / 5 : (position * DURATION_IN_FADE_ID / 6));
    ...
    public static void animateLeftRight(View view, int position) {
        ...
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.f);
        ObjectAnimator.ofFloat(view, "alpha", 0.f).start();
        animatorTranslateY.setStartDelay(not_first_item ? DURATION_IN_LEFT_RIGHT : (position * DURATION_IN_LEFT_RIGHT / 20));
    ...
    public static void animateRightLeft(View view, int position) {
        ...
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.f);
        ObjectAnimator.ofFloat(view, "alpha", 0.f).start();
        animatorTranslateY.setStartDelay(not_first_item ? DURATION_IN_RIGHT_LEFT : (position * DURATION_IN_RIGHT_LEFT / 20));
